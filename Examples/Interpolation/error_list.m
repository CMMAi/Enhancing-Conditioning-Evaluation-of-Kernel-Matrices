...
%%% see "https://num.math.uni-goettingen.de/schaback/research/papers/MPfKBM.pdf"
%for more detilas on RBF coding
% mECN denotes ECN that \sigma_n is from Matlab
% pECN denotes ECN that \sigma_n is from proposed alg.
warning off
global RBFscale
global RBFpar  
global RBFtype 
...
RBFpar=par
%% inputs
% set the shape or scale parameter for loop
