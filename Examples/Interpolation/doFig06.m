...
for j=1:length(n)
    ...
    %%% get \sigma_n from the MATLAB SVDS
    tic
    [v1,smin] = svds(A,1,'smallest'); 
    times(j)  = toc;    
...
%% plot
semilogx(n,timem,'r-*','LineWidth',2);hold on
semilogx(n,times,'b-o','LineWidth',2)
semilogx(n,timep,'g-o','LineWidth',2)

xlabel('n')
ylabel('CPU(s)')
legend('Matlab SVD','Matlab svds','proposed alg.')
set(gca,'FontSize',18);
fprintf('=============================================\n')
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%